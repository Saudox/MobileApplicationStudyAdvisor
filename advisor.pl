...
course(computer_society1,'Computer & Society 1',easy,0).
...
%%%%%%%%%%%%%%%%%%%%%%%%%% FACTS %%%%%%%%%%%%%%%%%%%%%%%%%%%
% course(id, display_name, difficulty, level)
% - Static data, no need to change


%%%%%%%%%%%%%%%%%%%%%%%%%% RULES %%%%%%%%%%%%%%%%%%%%%%%%%%%
% - All rules are defined above, no need to change

%%%%%%%%%%%%%%%%%%%%%%%%%%% USAGE %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% > DJANGO:
%   - Before querying, assert student data using:
%       student_completed(StudentID, CourseID)
%       love(StudentID, Category)
%   - Query using: recommend(StudentID, Course)
%   - After query, clean up asserted facts using : 
%       retractall(student_completed(StudentID, _))
%       retractall(love(StudentID, _))
%
% > MOBILE APP:
%   - Send student completed courses and interests to Django
%   - Interest options are: math, programming, hardware, theory, ai, systems , general
%   - Display the course list returned from Django
